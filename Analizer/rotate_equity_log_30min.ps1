# Equity Log Rotation Script - XAU 30-Minutes Terminal
# This script rotates the EquityLogClean.csv file daily at 7am
# It archives the current file with a date suffix for the 30-minute trading strategy
# MT4 will automatically create a new file when needed

param(
    [string]$LogPath = "C:\Users\maste\AppData\Roaming\MetaQuotes\Terminal\F98AB714D4506214DE128F0BA558C94B\MQL4\Files\EquityLogClean.csv",
    [string]$ArchiveDir = "C:\Users\maste\OneDrive\Documentos\archived_logs\xau-30-minutes"
)
...
try {
    Write-Log "Starting equity log rotation for XAU 30-minutes terminal..."
    ...
    Write-Log "Equity log rotation completed successfully for XAU 30-minutes terminal"
